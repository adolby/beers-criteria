...
var G__7439 = format;
var G__7439__$1 = (((G__7439 instanceof cljs.core.Keyword))?G__7439.fqn:null);
switch (G__7439__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__7441 = cljs.core.second(format);
var G__7442 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__7441,G__7442) : ajax.easy.keyword_response_format_element.call(null,G__7441,G__7442));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7445_SHARP_){
return ajax.easy.keyword_response_format_element(p1__7445_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__7446){
var map__7447 = p__7446;
var map__7447__$1 = (((((!((map__7447 == null))))?(((((map__7447.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7447.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7447):map__7447);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7447__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7447__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7447__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__7447,map__7447__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__7449){
var vec__7450 = p__7449;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7450,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7450,(1),null);
var fexpr__7453_7454 = (cljs.core.truth_(ok)?h:e);
(fexpr__7453_7454.cljs$core$IFn$_invoke$arity$1 ? fexpr__7453_7454.cljs$core$IFn$_invoke$arity$1(result) : fexpr__7453_7454.call(null,result));
...
;})(h,e,map__7447,map__7447__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__7455){
var map__7456 = p__7455;
var map__7456__$1 = (((((!((map__7456 == null))))?(((((map__7456.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7456.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7456):map__7456);
var opts = map__7456__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7456__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7456__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7456__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7456__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7456__$1,cljs.core.cst$kw$body);
