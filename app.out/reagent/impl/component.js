...
if((i < len)){
var k = (ks[i]);
var G__5778 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5779 = (i + (1));
m = G__5778;
i = G__5779;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5780 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__5780) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__5780));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5782 = c;
var G__5782__$1 = (((G__5782 == null))?null:G__5782.prototype);
if((G__5782__$1 == null)){
return null;
} else {
return (G__5782__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__5784 = c;
var G__5784__$1 = (((G__5784 == null))?null:G__5784.prototype);
if((G__5784__$1 == null)){
return null;
} else {
return (G__5784__$1["render"]);
}
})() == null)))));
});
...
var G__5786 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5786) : reagent.impl.component.as_element.call(null,G__5786));
};
...
while (G__5789__i < G__5789__a.length) {G__5789__a[G__5789__i] = arguments[G__5789__i + 0]; ++G__5789__i;}
  args = new cljs.core.IndexedSeq(G__5789__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__5792 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__5793 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__5793;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__5792;
}});
...
return ((function (G__5794,G__5794__$1){
...
var c = this;
var G__5799_5801 = (c["cljsRatom"]);
if((G__5799_5801 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5799_5801);
}
...
var renders_5803 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_5804 = cljs.core.first(cljs.core.vals(renders_5803));
if((cljs.core.count(renders_5803) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5803))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5804)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5804], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5802 = name;
switch (G__5802) {
case "":
...
var G__5807 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__5807) : reagent.impl.component.global$module$create_react_class.call(null,G__5807));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5808 = fiber;
var G__5808__$1 = (((G__5808 == null))?null:(G__5808["type"]));
if((G__5808__$1 == null)){
return null;
} else {
return (G__5808__$1["displayName"]);
}
})();
var parent = (function (){var G__5809 = fiber;
if((G__5809 == null)){
return null;
} else {
return (G__5809["return"]);
}
})();
var path = (function (){var G__5810 = parent;
var G__5810__$1 = (((G__5810 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5810) : reagent.impl.component.fiber_component_path.call(null,G__5810)));
if((G__5810__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5810__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__5812 = c;
if((G__5812 == null)){
return null;
} else {
return (G__5812["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__5813._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__5815 = c;
if((G__5815 == null)){
return null;
} else {
return (G__5815["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__5817 = c;
if((G__5817 == null)){
return null;
} else {
return G__5817._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__5819 = instance;
if((G__5819 == null)){
return null;
} else {
return (G__5819["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__5820 = instance;
if((G__5820 == null)){
return null;
} else {
return G__5820._currentElement;
}
}
})();
var name = (function (){var G__5821 = elem;
var G__5821__$1 = (((G__5821 == null))?null:(G__5821["type"]));
if((G__5821__$1 == null)){
return null;
} else {
return (G__5821__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__5823 = elem;
if((G__5823 == null)){
return null;
} else {
return (G__5823["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__5824._owner;
}
}
})();
var path = (function (){var G__5825 = owner;
var G__5825__$1 = (((G__5825 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5825) : reagent.impl.component.component_path.call(null,G__5825)));
if((G__5825__$1 == null)){
return null;
} else {
...
var G__5826 = c;
var G__5826__$1 = (((G__5826 == null))?null:G__5826.constructor);
if((G__5826__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5826__$1);
}
}
})();
