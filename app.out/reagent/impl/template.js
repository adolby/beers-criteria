...
var G__5846 = o;
(G__5846[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__5848__i < G__5848__a.length) {G__5848__a[G__5848__i] = arguments[G__5848__i + 0]; ++G__5848__i;}
  args = new cljs.core.IndexedSeq(G__5848__a,0,null);
} 
...
var G__5850 = o;
(G__5850[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__5855 = props;
var G__5855__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5855,cljs.core.cst$kw$id,id):G__5855);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5855__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__5856){
var map__5857 = p__5856;
var map__5857__$1 = (((((!((map__5857 == null))))?(((((map__5857.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5857.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5857):map__5857);
var props = map__5857__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5857__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__5857,map__5857__$1,props,class$){
return (function (c){
...
});})(map__5857,map__5857__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5859){
var map__5860 = p__5859;
var map__5860__$1 = (((((!((map__5860 == null))))?(((((map__5860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5860):map__5860);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5860__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5860,map__5860__$1,on_write){
return (function (){
...
});})(node_value,map__5860,map__5860__$1,on_write))
);
} else {
...
var G__5863 = jsprops;
(G__5863["defaultValue"] = value);

(G__5863["onChange"] = ((function (G__5863,v,value,on_change){
return (function (p1__5862_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5862_SHARP_);
});})(G__5863,v,value,on_change))
);
...
var vec__5866 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5866,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5866,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5866,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___5870 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___5870 == null)){
} else {
var key_5871 = temp__5724__auto___5870;
(jsprops["key"] = key_5871);
}
...
var temp__5724__auto___5872 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___5872 == null)){
} else {
var key_5873 = temp__5724__auto___5872;
reagent.impl.template.oset(jsprops,"key",key_5873);
}
...
var G__5874 = reagent.impl.template.__GT_NativeWrapper();
(G__5874["name"] = c);
...
var G__5875 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5875) : reagent.impl.template.as_element.call(null,G__5875));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5879){
var G__5880 = cljs.core.first(seq5879);
var seq5879__$1 = cljs.core.next(seq5879);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5880,seq5879__$1);
});
...
break;
default:
var G__5886 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5886;
continue;
...
var n__4607__auto___5888 = a.length;
var i_5889 = (0);
while(true){
if((i_5889 < n__4607__auto___5888)){
(a[i_5889] = reagent.impl.template.as_element((a[i_5889])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___5891 = a.length;
var i_5892 = (0);
while(true){
if((i_5892 < n__4607__auto___5891)){
var val_5893 = (a[i_5892]);
if(((cljs.core.vector_QMARK_(val_5893)) && ((reagent.impl.template.key_from_vec(val_5893) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5892] = reagent.impl.template.as_element(val_5893));

var G__5894 = (i_5892 + (1));
i_5892 = G__5894;
continue;
} else {
}
...
var ctx = ({});
var vec__5895 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5895,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5895,(1),null);
...
var G__5898 = (cljs.core.count(argv) - first_child);
switch (G__5898) {
case (0):
...
var G__5899 = comp;
var G__5900 = jsprops;
var G__5901 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__5899,G__5900,G__5901) : reagent.impl.template.global$module$react.createElement.call(null,G__5899,G__5900,G__5901));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__5898){
