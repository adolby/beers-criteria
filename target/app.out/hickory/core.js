...
var m__5824__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__5823__auto__)]);
...
var m__5824__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__5823__auto__ = (((this$ == null))?null:this$);
var m__5824__auto__ = (hickory.core.as_hickory[goog.typeOf(x__5823__auto__)]);
if(!((m__5824__auto__ == null))){
return (m__5824__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5824__auto__.cljs$core$IFn$_invoke$arity$1(this$) : m__5824__auto__.call(null,this$));
} else {
var m__5824__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__5824__auto____$1 == null))){
return (m__5824__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__5824__auto____$1.cljs$core$IFn$_invoke$arity$1(this$) : m__5824__auto____$1.call(null,this$));
} else {
...
var pred__17378 = cljs.core._EQ_;
var expr__17379 = (this$["nodeType"]);
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__17379) : pred__17378.call(null,hickory.core.Attribute,expr__17379)))){
...
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__17379) : pred__17378.call(null,hickory.core.Comment,expr__17379)))){
return [cljs.core.str("<!--"),cljs.core.str((this$["data"])),cljs.core.str("-->")].join('');
} else {
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__17379) : pred__17378.call(null,hickory.core.Document,expr__17379)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__17379) : pred__17378.call(null,hickory.core.DocumentType,expr__17379)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__17379) : pred__17378.call(null,hickory.core.Element,expr__17379)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (tag,pred__17378,expr__17379){
return (function (p1__17377_SHARP_){
return (p1__17377_SHARP_["wholeText"]);
});})(tag,pred__17378,expr__17379))
,(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__17378.cljs$core$IFn$_invoke$arity$2 ? pred__17378.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__17379) : pred__17378.call(null,hickory.core.Text,expr__17379)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__17379)].join('')));
}
}
}
}
...
var expr__17382 = (this$["nodeType"]);
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__17382) : pred__17381.call(null,hickory.core.Attribute,expr__17382)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__17382) : pred__17381.call(null,hickory.core.Comment,expr__17382)))){
...
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__17382) : pred__17381.call(null,hickory.core.Document,expr__17382)))){
...
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__17382) : pred__17381.call(null,hickory.core.DocumentType,expr__17382)))){
...
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__17382) : pred__17381.call(null,hickory.core.Element,expr__17382)))){
...
if(cljs.core.truth_((pred__17381.cljs$core$IFn$_invoke$arity$2 ? pred__17381.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__17382) : pred__17381.call(null,hickory.core.Text,expr__17382)))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__17382)].join('')));
}
}
}
}
...
var temp__4425__auto__ = cljs.core.second((function (){var or__5168__auto__ = cljs.core.re_find(/<!DOCTYPE ([^>]*)>/,s);
...
var temp__4425__auto___17384 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4425__auto___17384)){
var title_el_17385 = temp__4425__auto___17384;
if(cljs.core.empty_QMARK_((title_el_17385["text"]))){
hickory.core.remove_el(title_el_17385);
} else {
}
} else {
}
...
var or__5168__auto__ = hickory.core.parse_dom_with_domparser(s);
if(cljs.core.truth_(or__5168__auto__)){
return or__5168__auto__;
} else {
