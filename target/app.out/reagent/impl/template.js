...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5766__auto__,writer__5767__auto__,opt__5768__auto__){
return cljs.core._write(writer__5767__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__5168__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__5168__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__5168__auto__)){
return or__5168__auto__;
} else {
...
var G__16009 = o;
(G__16009[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_16013 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_16013))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_16013)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__5156__auto__ = (node === document.activeElement);
if(and__5156__auto__){
var and__5156__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
if(cljs.core.truth_((function (){var and__5156__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__16016 = jsprops;
(G__16016["defaultValue"] = value);

(G__16016["onChange"] = ((function (G__16016,v,value,on_change){
return (function (p1__16014_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16014_SHARP_);
});})(G__16016,v,value,on_change))
);
...
var vec__16018 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16018,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16018,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16018,(2),null);
...
var temp__4427__auto__ = (function (){var G__16022 = cljs.core.meta(v);
var G__16022__$1 = (((G__16022 == null))?null:reagent.impl.template.get_key(G__16022));
return G__16022__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__16024_16025 = v;
var G__16024_16026__$1 = (((G__16024_16025 == null))?null:reagent.impl.template.key_from_vec(G__16024_16025));
var G__16024_16027__$2 = (((G__16024_16026__$1 == null))?null:(jsprops["key"] = G__16024_16026__$1));
...
var G__16031 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__16031) : reagent.impl.template.as_element.call(null,G__16031));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__16032 = cljs.core.meta(argv);
var G__16032__$1 = (((G__16032 == null))?null:reagent.impl.template.get_key(G__16032));
return G__16032__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__16033 = (((jsprops == null))?{}:jsprops);
(G__16033["key"] = key);
...
var G__16034 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__16034;
continue;
}
} else {
...
var n__6071__auto___16035 = a.length;
var i_16036 = (0);
while(true){
if((i_16036 < n__6071__auto___16035)){
(a[i_16036] = reagent.impl.template.as_element((a[i_16036])));

var G__16037 = (i_16036 + (1));
i_16036 = G__16037;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__6071__auto___16038 = a.length;
var i_16039 = (0);
while(true){
if((i_16039 < n__6071__auto___16038)){
var val_16040 = (a[i_16039]);
if((cljs.core.vector_QMARK_(val_16040)) && ((reagent.impl.template.key_from_vec(val_16040) == null))){
(o["no-key"] = true);
} else {
}

(a[i_16039] = reagent.impl.template.as_element(val_16040));
...
if(cljs.core.truth_((function (){var and__5156__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__5156__auto__){
return (ctx["no-key"]);
} else {
return and__5156__auto__;
...
var G__16043 = (cljs.core.count(argv) - first_child);
switch (G__16043) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__16043){
