...
var len__6226__auto___15727 = arguments.length;
var i__6227__auto___15728 = (0);
while(true){
if((i__6227__auto___15728 < len__6226__auto___15727)){
args__6233__auto__.push((arguments[i__6227__auto___15728]));

var G__15729 = (i__6227__auto___15728 + (1));
i__6227__auto___15728 = G__15729;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq15726){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15726));
});
/**
...
var vec__15731 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15731,(0),null);
var words = cljs.core.nthnext(vec__15731,(1));
...
var G__15733 = clojure.set.rename_keys(m,kmap);
var G__15733__$1 = ((cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__15733,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys):G__15733);
return G__15733__$1;
} else {
return m;
}
...
var args__6233__auto__ = [];
var len__6226__auto___15736 = arguments.length;
var i__6227__auto___15737 = (0);
while(true){
if((i__6227__auto___15737 < len__6226__auto___15736)){
args__6233__auto__.push((arguments[i__6227__auto___15737]));

var G__15738 = (i__6227__auto___15737 + (1));
i__6227__auto___15737 = G__15738;
continue;
} else {
}
break;
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__15734_SHARP_){
if(cljs.core.list_QMARK_(p1__15734_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15734_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__15734_SHARP_)){
return p1__15734_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15734_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq15735){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15735));
});
/**
...
var vec__15742 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__15742,tag_name,names){
return (function (p1__15739_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__15739_SHARP_));
});})(matches,vec__15742,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__15742,tag_name,names){
return (function (p1__15740_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__15740_SHARP_));
});})(matches,vec__15742,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__15743){
var vec__15746 = p__15743;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15746,(0),null);
var content = cljs.core.nthnext(vec__15746,(1));
...
var vec__15747 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(2),null);
